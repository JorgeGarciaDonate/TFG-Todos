      ...
      $(elm).each(function () {
        ...
        var def = {
          ...
          language: {
            search: "Cerca: ",
            searchPlaceholder: "",
            lengthMenu: "<span class='d-none d-sm-inline-block'>Mostra</span><div class='form-control-select'> _MENU_ </div><span class='d-none d-sm-inline-block'> Risultati</span>",
            info: "_START_ -_END_ di _TOTAL_",
            infoEmpty: "Nessun Risultato",
            infoFiltered: "( Totale _MAX_  )",
            paginate: {
              "first": "Primo",
              "last": "Ultimo",
              "next": "Successivo",
